    ...
    <footer className="bg-primary text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 text-sm mb-4">
              Fostering global connections and academic excellence. The Office of International Affairs at Medicaps University opens doors to a world of opportunities.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              ...
              <li><Link href="/student-exchange" className="hover:text-white transition-colors">Student Exchange</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><Link href="/dual-degrees" className="hover:text-white transition-colors">Dual Degrees</Link></li>
              <li><Link href="/joint-research" className="hover:text-white transition-colors">Joint Research</Link></li>
              <li><Link href="/faculty-mobility" className="hover:text-white transition-colors">Faculty Mobility</Link></li>
              <li><Link href="/summer-schools" className="hover:text-white transition-colors">Summer Schools</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300 text-sm">
              ...
              <li className="flex items-start">
                ...
                <span>Location: Indore, India</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-gray-700 py-6">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
          <p>© 2024 Medicaps University. All rights reserved.</p>
          <div className="flex mt-4 md:mt-0">
            <Link href="/privacy-policy" className="mr-4 hover:text-white transition-colors">
              Privacy Policy
            </Link>
